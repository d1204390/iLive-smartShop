      ...
      <div class="privacy-content">
        <el-collapse v-model="activeNames" accordion>
          ...
          <el-collapse-item title="我們收集哪些資訊以及如何使用資訊" name="2">
            ...
            <p>（2）完善帳號資訊</p>
            <p>您在使用iLive提供的各類服務過程中，您可以透過完善頭貼、暱稱、性別、收貨地址等基礎資訊，來獲得更好的服務與體驗，如不提供也不會影響iLive帳號的基本功能。</p>

            <h4>2、保障註冊、登入安全所必須的功能</h4>
            <p>為提高您使用我們的產品與/或服務時系統的安全性，更準確地預防釣魚網站欺詐和保護帳戶安全，我們還會透過簡訊驗證、郵件驗證碼（如果需要）來驗證您的身份。為此我們需要收集您的簡訊驗證碼、郵件驗證碼。</p>
            <p>此外，我們還會收集您的註冊/登入時間、裝置相關資訊、網路資訊（如IP地址）來判斷目前的註冊、登入環境是否安全。</p>
          </el-collapse-item>
